...
import kotlinx.android.synthetic.main.view_template_control_v1.view.*
...
class TemplateControlViewVer1 @JvmOverloads constructor(context: Context, attrs: AttributeSet? = null) : FrameLayout(context, attrs) {
    ...
    init {
        LayoutInflater.from(context).inflate(R.layout.view_template_control_v1, this, true)
...
*/
    ...
    private fun expand() {
        ...
        TransitionManager.beginDelayedTransition(this@TemplateControlViewVer1, transiion)
