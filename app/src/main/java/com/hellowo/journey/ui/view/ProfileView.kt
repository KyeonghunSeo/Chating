...
class ProfileView @JvmOverloads constructor(context: Context, attrs: AttributeSet? = null, defStyleAttr: Int = 0)
    ...
    private val profileMargin = dpToPx(10)
    private val headerHeight = dpToPx(70f)
    ...
    fun show() {
        ...
        MainActivity.getProfileBtn()?.let { profileBtn ->
            ...
            (profileBtn.layoutParams as FrameLayout.LayoutParams).let {
                ...
                it.setMargins(dpToPx(14), headerHeight.toInt(), 0, 0)
            }
            requestLayout()
        }
    ...
    fun hide() {
        MainActivity.getProfileBtn()?.let { profileBtn ->
            ...
            (profileBtn.layoutParams as FrameLayout.LayoutParams).let {
                ...
                it.setMargins(0, profileMargin, profileMargin, 0)
            }
            requestLayout()
        }
